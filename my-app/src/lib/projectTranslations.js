...
const projectTranslations = {
  ...
  'Hercules-Fichas_Tecnicas': {
    ...
    description: {
      es: 'Sistema para crear, consultar y organizar fichas técnicas de productos industriales en un entorno web.',
      en: 'System to create, query, and organize industrial product technical datasheets in a web environment.',
    },
    ...
    caseStudy: {
      es: {
        ...
        solution: 'Implementé una plataforma web que estandariza la estructura de fichas técnicas y facilita su búsqueda y actualización.',
      ...
      en: {
        ...
        solution: 'I implemented a web platform that standardizes datasheet structure and makes search and updates easier.',
